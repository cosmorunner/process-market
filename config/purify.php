    ...
    */
    ...
    'settings' => [
        ...
        */
        ...
        'HTML.Allowed' => '&Auml;,&Uuml;,&Ouml;&auml;,&uuml;,&ouml;,div,h1,h2,h3,h4,h5,h6,b,strong,i,em,a[href|title],p[style],br,span,*[style],*[title]',
        'HTML.AllowedAttributes' => 'style,class,href,src,alt,width,height,colspan',
        ...
        |--------------------------------------------------------------------------
        |
        | Indicates whether or not the user's CSS input is trusted or not.
        |
        ...
        */
        ...
        'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,padding-right,padding-bottom,padding-left,margin-top,margin-right,margin-bottom,margin-left,color,background-color,text-align,border,border-top,border-right,border-bottom,border-left,max-width,min-width,width,height',
