 ...
 */
class DeleteState implements ValidationRule {
    ...
    public function __construct(array $payload) {
        ...
        $this->statusTypeId = $payload['status_type_id'] ?? null;
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void {
        if (!$this->statusType instanceof StatusType) {
        ...
        $validator = Validator::make((array) $value, [
            ...
            'state_id' => [
                ...
                'string',
                'uuid',
                Rule::in($this->statusType->states->pluck('id'))
            ],
        ], [], [
