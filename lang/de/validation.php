...
return [
    ...
    */
    ...
    'model_pipe' => ':attribute muss einer gültigen Model-Pipe-Notation entsprechen und das Model muss existieren.',
    ...
    */
    'custom' => [
        ...
        'email' => [
            'unique-system' => 'Ein Benutzer mit dieser E-Mail Adresse existiert bereits.'
        ],
        'columns' => [
            'columns-exist' => 'Die angegebenen Spalten-Namen existieren nicht in der Listenkonfiguration.'
        ],
        'groups' => [
            'role-selected' => 'Bitte wählen Sie für jede selektierte Gruppe eine Rolle.'
        ],
        'role' => [
            'default-system-role-must-exists' => 'Eine Standard-System-Rolle muss konfiguriert sein.',
            'default-system-role-undeletable' => 'Die Standard-System-Rolle kann nicht gelöscht werden.',
            'administrator-role-undeletable' => 'The Administrator-Rolle kann nicht gelöscht werden.'
        ]
    ],
    /*
    |--------------------------------------------------------------------------
