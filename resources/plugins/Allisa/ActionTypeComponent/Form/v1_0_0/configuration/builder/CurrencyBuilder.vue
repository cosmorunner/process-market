                ...
                <div class="col">
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <span class="badge badge-light" v-if="field.showDecimals">Dezimalstellen</span>
                            <span class="badge badge-light" v-if="field.showCurrencyCode">Währungscode</span>
                        </div>
                        <div></div>
                    </div>
                </div>
    ...
    computed: {
        shouldDisplayHr() {
            return (this.field.label || this.field.helper_text)
                && (this.field.default || this.field.css_classes
                    || (this.field.computed_input && this.field.computed_input.length)
                    || this.field.highlighted
                    || this.field.showDecimals
                    || this.field.showCurrencyCode);
        }
    }
};
</script>
