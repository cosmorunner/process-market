            ...
            <div class="row">
                <div class="col">
                    <div class="d-flex justify-content-between">
                        <div>
                            <span class="badge badge-light" v-if="field.output_format">Format: {{ field.output_format }}</span>
    ...
    computed: {
        shouldDisplayHr() {
            return (this.field.label || this.field.helper_text)
                && (this.field.output_format || this.field.css_classes || this.field.highlighted);
        }
    },
};
</script>
