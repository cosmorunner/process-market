        ...
        <div class="row">
            <div class="col-sm-12 col-md-4">
                ...
                <ul class="list-group mb-3 list-group-flush text-muted">
                    <li class="p-1 pl-2 list-group-item">Ihre Prozesse werden auf "Privat" gesetzt.</li>
                    <li class="p-1 pl-2 list-group-item">Sie werden aus allen Organisation entfernt.</li>
                    <li class="p-1 pl-2 list-group-item">Sie können sich nicht mehr einloggen.</li>
                </ul>
            </div>
            <div class="col-sm-12 col-md-8">
                <div class="container px-0">
                    <form id="form-update-password" role="form" method="POST"
                          action="{{route('profile.close')}}"
                          novalidate>
                        @csrf
                        @method('DELETE')
                        <div class="row">
