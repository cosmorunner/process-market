...
@section('content')
    <div class="container">
        <div class="row py-4 justify-content-center">
            <div class="col-md-8">
                <a href="{{route('settings.systems')}}">Zurück</a>
            </div>
        </div>
                        ...
                        <form method="POST" action="{{ route('settings.system.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted">Erstellen Sie im Administrations-Bereich der
                                        Allisa Plattform unter "API Clients" einen "Client Credentials"-Client
                                        und geben Sie hier die Client-Id und das Client-Secret ein.</small>
                                    @error('client_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                <label for="client_id"
                                       class="col-md-4 col-form-label text-md-right">Client-Secret</label>
                                <div class="col-md-6">
