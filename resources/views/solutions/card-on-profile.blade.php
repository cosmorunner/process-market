...
<div class="card">
    <div class="card-header p-2 d-flex justify-content-between border-bottom">
        <span class="text-truncate font-weight-bold">
            <a class="text-truncate" href="{{route('solution.config', $solution)}}">{{shorten((string) $solution->name, 50)}}</a>
            <div>
        ...
        <div class="d-flex justify-content-end">
            <a class="d-inline-block px-2"
               href="{{route('solution.demo', ['solution' => $solution, 'version' => 'develop']) . '?ref=' . base64_encode('profile.solutions')}}">Benutzer-Demo</a>
            <a class="d-inline-block px-2"
               href="{{route('solution.complete', $solution)}}">Fertigstellen</a>
