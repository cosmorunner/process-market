...
@section('settings.content')
    <div class="container bg-white border border-top-0 p-3">
        <div class="row mb-3">
            <div class="col">
                <a href="{{route('organisation.settings.system.create', $organisation)}}">
        ...
        <div class="row">
                ...
                <div class="col-12">
                    <div class="card mb-3">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <form method="POST" action="{{route('organisation.settings.system.delete', ['organisation' => $organisation, 'system' => $system])}}">
                                @csrf
                                @method('DELETE')
            ...
            @empty
                <div class="col">Fügen Sie Allisa Plattformen hinzu, um fertiggestellte Prozess-Versionen dorthin zu importieren.</div>
            @endforelse
        </div>
    </div>
@endsection
