        ...
        <div class="input-group-append">
            ...
            <div class="dropdown-menu scrollable-dropdown">
                <template v-if="!isRuleForRole">
                    ...
                    <button type="button" class="dropdown-item" @click="changeValue" data-index="3" :data-value="'js|false'">
                        FALSE
                    </button>
                    <button type="button" class="dropdown-item" @click="changeValue" data-index="3" :data-value="'js|empty_array_object'">
