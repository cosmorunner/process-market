    ...
    public function up() {
        ProcessVersion::query()->with('process')->chunk(10, function (Collection $versions) {
            ...
            foreach ($versions as $version) {
                ...
                $dependencies['action_type_component_plugins'] = $dependencies['action_type_plugins'];
                unset($dependencies['action_type_plugins']);
    ...
    public function down() {
        ProcessVersion::query()->with('process')->chunk(10, function (Collection $versions) {
            ...
            foreach ($versions as $version) {
                ...
                $dependencies = $definition['dependencies'];
                $dependencies['action_type_plugins'] = $dependencies['action_type_component_plugins'];
                unset($dependencies['action_type_component_plugins']);
                $definition['dependencies'] = $dependencies;
